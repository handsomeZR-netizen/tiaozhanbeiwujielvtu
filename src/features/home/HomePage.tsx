    ...
    <div className="min-h-full bg-paper pb-8 bg-texture">
      <div className="bg-white border-b border-stone-200 p-6 pt-12 rounded-b-[2rem] shadow-paper relative overflow-hidden">
        ...
        <div className="flex justify-between items-end mb-8 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] bg-ink text-white px-1.5 py-0.5 rounded-sm tracking-widest uppercase">今日</span>
              <h2 className="text-stone-500 text-xs tracking-widest font-bold uppercase">杭州 · 晴</h2>
            </div>
            <h1 className="text-4xl font-serif font-bold text-ink">02 月</h1>
          </div>
        ...
        <div className="relative py-4 border-t border-stone-100">
          ...
          <p className="font-serif italic text-lg text-ink/80 pl-4 leading-relaxed">城市一角，也能成为旅途的答案。</p>
          <p className="text-[10px] text-stone-400 pl-4 mt-1 uppercase tracking-widest">今日灵感语录</p>
        </div>
      </div>
      ...
      <div className="p-5 space-y-8">
        <section>
          <div className="flex justify-between items-center mb-4 px-1">
            ...
            <span className="text-[10px] font-bold bg-stone-200 text-stone-600 px-2 py-1 rounded-sm tracking-wider">第 1 天</span>
          </div>

          <div className="grid grid-cols-3 gap-3">
            {[
              { label: '灵感', val: 80, color: 'bg-blue-600', text: 'text-blue-600', icon: Zap },
              { label: '舒适', val: 30, color: 'bg-emerald-600', text: 'text-emerald-600', icon: Cloud },
              { label: '电量', val: 5, color: 'bg-amber-600', text: 'text-amber-600', icon: Battery },
            ].map((item, idx) => (
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="font-serif font-bold text-ink text-lg">探索地图</p>
                  <p className="text-xs text-sub mt-0.5">发现附近值得一去的文化地标</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="text-left">
                  <p className="font-serif font-bold text-ink text-lg">生成海报</p>
                  <p className="text-xs text-sub mt-0.5">把这一刻做成你的旅行封面</p>
                </div>
              </div>
          ...
          <div className="relative pl-6 ml-2 border-l border-dashed border-stone-300 space-y-8 pb-4">
            <div className="relative group cursor-pointer">
              ...
              <div className="bg-white p-4 rounded-sm border border-stone-200 shadow-sm rotate-1 transition-transform group-hover:rotate-0 group-hover:shadow-md relative">
                <div className="absolute -top-2 left-4 w-12 h-4 bg-stone-100/80 -rotate-2"></div>
                <div className="flex justify-between items-start mb-2">
                  <div className="text-[10px] font-bold text-stone-400 tracking-widest uppercase">周五 14:00</div>
                  <Stamp size={16} className="text-stone-200" />
                </div>
                <p className="font-serif text-ink italic leading-relaxed">在老巷子里，闻见午后的烟火气。</p>
                <div className="flex gap-2 mt-3">
                  <span className="px-2 py-1 bg-stone-100 text-[10px] font-serif text-stone-600 border border-stone-200">#老城</span>
                  <span className="px-2 py-1 bg-stone-100 text-[10px] font-serif text-stone-600 border border-stone-200">#街巷</span>
                </div>
              </div>
            </div>
          </div>
